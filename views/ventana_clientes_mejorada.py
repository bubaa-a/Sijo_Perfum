...
class VentanaClientes:
    ...
    def crear_header_moderno(self):
        ...
        search_entry = ctk.CTkEntry(
            ...
            placeholder_text=f"{Iconos.BUSCAR} Buscar cliente...",
            width=280,
        ...
        search_entry.grid(row=0, column=1, sticky='e', padx=Espaciado.XL, pady=Espaciado.MEDIO)
    ...
    def crear_botones_modernos(self, parent):
        ...
        botones_config = [
            (f"{Iconos.GUARDAR} Nuevo", Colores.SUCCESS, self.nuevo_cliente),
